...
\begin{axis}[
	...
	axis lines = left,
	grid = both,	domain = 0:100
]
\addplot[
	color=black,
	name path=R0
]
{(8.00000-1.00000*x)/4.00000};
\addplot[
	color=black,
	name path=R1
]
{(4.00000-1.00000*x)/2.00000};
\addplot[
	color=red,
	name path=S
]
{min((8.00000-1.00000*x)/4.00000,(4.00000-1.00000*x)/2.00000)};
\end{axis}
\end{tikzpicture}
...
$Z$ & $x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $B$\\ 
 \hline 
1,00 & 3,00 & 9,00 & 0,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & 1,00 & 4,00 & 1,00 & 0,00 & 8,00\\ 
 \hline 
...
\textbf{Draw:} the rows 1 and 2 have a fraction of the same value,\textbf{row 1} (fraction 2,00000) with the 4,00000 pivot was \textbf{choosen} and \textbf{row 2} (fraction 2,00000) with the 2,00000 pivot was \textbf{stored} along with the table in case it is needed.\\
...
\begin{tabular}{|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $x_{1}$ & \cellcolor{PurpleNoMamado}$x_{2}$ & $s_{1}$ & $s_{2}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & 3,00 & \cellcolor{PurpleNoMamado}9,00 & 0,00 & 0,00 & 0,00 & $-$\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}4,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}8,00 & \cellcolor{PurpleNoMamado}2,00\\ 
 \hline 
0,00 & 1,00 & \cellcolor{PurpleNoMamado}2,00 & 0,00 & 1,00 & 4,00 & 2,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & \cellcolor{PurpleNoMamado}$x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & \cellcolor{PurpleNoMamado}0,75 & 0,00 & -2,25 & 0,00 & -18,00 & $-$\\ 
 \hline 
0,00 & \cellcolor{PurpleNoMamado}0,25 & 1,00 & 0,25 & 0,00 & 2,00 & 8,00\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,50 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}-0,50 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
$Z$ & $x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $B$\\ 
 \hline 
1,00 & 0,00 & 0,00 & -1,50 & -1,50 & -18,00\\ 
 \hline 
0,00 & 0,00 & 1,00 & 0,50 & -0,50 & 2,00\\ 
 \hline 
0,00 & 1,00 & 0,00 & -1,00 & 2,00 & 0,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
z=-18,00\\
\textbf{Solution 1:}\\
$x_{1}: 0,00, x_{2}: 2,00, s_{1}: 0,00, s_{2}: 0,00$\\
