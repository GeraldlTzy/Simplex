...
{(40.00000-1.00000*x)/1.00000};
\addplot[
	color=black,
	name path=R1
]
{(60.00000-1.00000*x)/2.00000};
\addplot[
	color=red,
	name path=S
]
{min((40.00000-1.00000*x)/1.00000,(60.00000-1.00000*x)/2.00000)};
\end{axis}
\end{tikzpicture}
...
$Z$ & $x_{1}$ & \cellcolor{PurpleNoMamado}$x_{2}$ & $s_{1}$ & $s_{2}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & -3,00 & \cellcolor{PurpleNoMamado}-4,00 & 0,00 & 0,00 & 0,00 & $-$\\ 
 \hline 
0,00 & 1,00 & \cellcolor{PurpleNoMamado}1,00 & 1,00 & 0,00 & 40,00 & 40,00\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}2,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}60,00 & \cellcolor{PurpleNoMamado}30,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
$Z$ & \cellcolor{PurpleNoMamado}$x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & \cellcolor{PurpleNoMamado}-1,00 & 0,00 & 0,00 & 2,00 & 120,00 & $-$\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,50 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}-0,50 & \cellcolor{PurpleNoMamado}10,00 & \cellcolor{PurpleNoMamado}20,00\\ 
 \hline 
0,00 & \cellcolor{PurpleNoMamado}0,50 & 1,00 & 0,00 & 0,50 & 30,00 & 60,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
z=140,00\\
\textbf{Solution 1:}\\
$x_{1}: 20,00, x_{2}: 20,00, s_{1}: 0,00, s_{2}: 0,00$\\
