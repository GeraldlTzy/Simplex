...
\begin{tabular}{|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $x_{1}$ & $x_{2}$ & $e_{1}$ & $e_{2}$ & $a_{1}$ & $a_{2}$ & $B$\\ 
 \hline 
1,00 & -2,00 & -2,00 & 0,00 & 0,00 & -1,00*M & -1,00*M & 0,00\\ 
 \hline 
0,00 & 2,00 & 1,00 & -1,00 & 0,00 & 1,00 & 0,00 & 3,00\\ 
 \hline 
0,00 & 1,00 & 2,00 & 0,00 & -1,00 & 0,00 & 1,00 & 3,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
$Z$ & $x_{1}$ & $x_{2}$ & $e_{1}$ & $e_{2}$ & $a_{1}$ & $a_{2}$ & $B$\\ 
 \hline 
1,00 & 0,00 & 2,00 & 0,00 & -2,00 & -1,00*M & -1,00*M + 2,00 & 6,00\\ 
 \hline 
0,00 & 1,00 & 2,00 & 0,00 & -1,00 & 0,00 & 1,00 & 3,00\\ 
 \hline 
0,00 & 0,00 & 3,00 & 1,00 & -2,00 & -1,00 & 2,00 & 3,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
\section{Unbound solution found}
The program found an unbound solution during it's execution, meaning it can grow infinitely.\\
When choosing a pivot you first find the column that most benefits you to be pivoted, after doing that you choose the smallest fraction to make sure al restrictions are met.
