...
\begin{tikzpicture}
\begin{axis}[
	xmin = 0, ymin = 0,	axis lines = left,
	grid = both]
\addplot[
	color=black,
	name path=R0
]
{(4.00000-1.00000*x)/1.00000}
node[pos=0.8, above] {(4.00000-1.00000*x)/1.00000};
\addplot[
	color=black,
	name path=R1
]
{(6.00000-1.00000*x)/-1.00000}
node[pos=0.8, above] {(6.00000-1.00000*x)/-1.00000};
\end{axis}
\end{tikzpicture}
...
\begin{tabular}{|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $Feliz$ & \cellcolor{PurpleNoMamado}$Jueves$ & $s_{1}$ & $s_{2}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & -2,00 & \cellcolor{PurpleNoMamado}3,00 & 0,00 & 0,00 & 0,00 & $-$\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}4,00 & \cellcolor{PurpleNoMamado}4,00\\ 
 \hline 
0,00 & 1,00 & \cellcolor{PurpleNoMamado}-1,00 & 0,00 & 1,00 & 6,00 & $-$\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
$Z$ & $Feliz$ & $Jueves$ & $s_{1}$ & $s_{2}$ & $B$\\ 
 \hline 
1,00 & -5,00 & 0,00 & -3,00 & 0,00 & -12,00\\ 
 \hline 
0,00 & 1,00 & 1,00 & 1,00 & 0,00 & 4,00\\ 
 \hline 
0,00 & 2,00 & 0,00 & 1,00 & 1,00 & 10,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
