...
\end{dmath}
\begin{dmath}
1,00000x_{1} + 3,00000x_{2} \leq20,00000
\end{dmath}
\begin{dmath}
1,00000x_{1} + 1,00000x_{2} \leq10,00000
\end{dmath}
\begin{dmath}
x_{1},x_{2} \geq 0
\end{dmath}
...
\begin{tabular}{|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $s_{3}$ & $B$\\ 
 \hline 
1,00 & -2,00 & -3,00 & 0,00 & 0,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & 0,50 & 0,25 & 1,00 & 0,00 & 0,00 & 4,00\\ 
 \hline 
0,00 & 1,00 & 3,00 & 0,00 & 1,00 & 0,00 & 20,00\\ 
 \hline 
0,00 & 1,00 & 1,00 & 0,00 & 0,00 & 1,00 & 10,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
1,00 & -2,00 & -3,00 & 0,00 & 0,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & 0,12 & 0,06 & 0,25 & 0,00 & 0,00 & 1,00\\ 
 \hline 
0,00 & -1,50 & 1,75 & -5,00 & 1,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & -0,25 & 0,38 & -2,50 & 0,00 & 1,00 & 0,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
z=0,00\\
\textbf{Solution 1:}\\
$x_{1}: 0,00, x_{2}: 0,00, s_{1}: 4,00, s_{2}: 20,00, s_{3}: 10,00$\\
\textbf{Solution 2:}\\
$x_{1}: 0,00, x_{2}: 0,00, s_{1}: 0,00, s_{2}: 0,00, s_{3}: 0,00$\\
\textbf{Solution 3:}\\
$x_{1}: 0,00, x_{2}: 0,00, s_{1}: 1,00, s_{2}: 5,00, s_{3}: 2,50$\\
\textbf{Solution 4:}\\
$x_{1}: 0,00, x_{2}: 0,00, s_{1}: 2,00, s_{2}: 10,00, s_{3}: 5,00$\\
\textbf{Solution 5:}\\
$x_{1}: 0,00, x_{2}: 0,00, s_{1}: 3,00, s_{2}: 15,00, s_{3}: 7,50$\\
