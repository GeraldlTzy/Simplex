...
\begin{tabular}{|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $e_{1}$ & $a_{1}$ & $B$\\ 
 \hline 
1,00 & -10000,00 & -3000,00 & 0,00 & 0,00 & 0,00 & 1,00*M & 0,00\\ 
 \hline 
0,00 & 1,00 & 1,00 & 1,00 & 0,00 & 0,00 & 0,00 & 7,00\\ 
 \hline 
0,00 & 10,00 & 4,00 & 0,00 & 1,00 & 0,00 & 0,00 & 40,00\\ 
 \hline 
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $x_{1}$ & \cellcolor{PurpleNoMamado}$x_{2}$ & $s_{1}$ & $s_{2}$ & $e_{1}$ & $a_{1}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & -10000,00 & \cellcolor{PurpleNoMamado}-1,00*M + -3000,00 & 0,00 & 0,00 & 1,00*M & 0,00 & -3,00*M & $-$\\ 
 \hline 
0,00 & 1,00 & \cellcolor{PurpleNoMamado}1,00 & 1,00 & 0,00 & 0,00 & 0,00 & 7,00 & 7,00\\ 
 \hline 
0,00 & 10,00 & \cellcolor{PurpleNoMamado}4,00 & 0,00 & 1,00 & 0,00 & 0,00 & 40,00 & 10,00\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}-1,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}3,00 & \cellcolor{PurpleNoMamado}3,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & \cellcolor{PurpleNoMamado}$x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $e_{1}$ & $a_{1}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & \cellcolor{PurpleNoMamado}-10000,00 & 0,00 & 0,00 & 0,00 & -3000,00 & 1,00*M + 3000,00 & 9000,00 & $-$\\ 
 \hline 
0,00 & \cellcolor{PurpleNoMamado}1,00 & 0,00 & 1,00 & 0,00 & 1,00 & -1,00 & 4,00 & 4,00\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}10,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}4,00 & \cellcolor{PurpleNoMamado}-4,00 & \cellcolor{PurpleNoMamado}28,00 & \cellcolor{PurpleNoMamado}2,80\\ 
 \hline 
0,00 & \cellcolor{PurpleNoMamado}0,00 & 1,00 & 0,00 & 0,00 & -1,00 & 1,00 & 3,00 & $-$\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
$Z$ & $x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $e_{1}$ & $a_{1}$ & $B$\\ 
 \hline 
1,00 & 0,00 & 0,00 & 0,00 & 1000,00 & 1000,00 & 1,00*M + -1000,00 & 37000,00\\ 
 \hline 
0,00 & 0,00 & 0,00 & 1,00 & -0,10 & 0,60 & -0,60 & 1,20\\ 
 \hline 
0,00 & 1,00 & 0,00 & 0,00 & 0,10 & 0,40 & -0,40 & 2,80\\ 
 \hline 
0,00 & 0,00 & 1,00 & 0,00 & 0,00 & -1,00 & 1,00 & 3,00\\ 
 \hline 
\end{tabular} 
...
z=37000,00\\
\textbf{Solution 1:}\\
$x_{1}= 2,80; x_{2}= 3,00; s_{1}= 1,20; s_{2}= 0,00; e_{1}= 0,00; a_{1}= 0,00$\\
