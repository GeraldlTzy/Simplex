...
\textbf{Minimize:}
\begin{dmath}
z = 0,00000y_{1} + 0,00000y_{2} + 0,00000y_{3} + 1,00000y_{4} 
\end{dmath}
\textbf{Subject To:}
\begin{dmath}
5,00000y_{1} + 0,00000y_{2} + 6,00000y_{3} + -1,00000y_{4} \leq0,00000
\end{dmath}
\begin{dmath}
1,00000y_{1} + 6,00000y_{2} + 4,00000y_{3} + -1,00000y_{4} \leq0,00000
\end{dmath}
\begin{dmath}
4,00000y_{1} + 4,00000y_{2} + 8,00000y_{3} + -1,00000y_{4} \leq0,00000
\end{dmath}
\begin{dmath}
1,00000y_{1} + 1,00000y_{2} + 1,00000y_{3} + 0,00000y_{4} =1,00000
\end{dmath}
\begin{dmath}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $y_{1}$ & $y_{2}$ & $y_{3}$ & $y_{4}$ & $s_{1}$ & $s_{2}$ & $s_{3}$ & $a_{1}$ & $B$\\ 
 \hline 
1,00 & -0,00 & -0,00 & -0,00 & -1,00 & 0,00 & 0,00 & 0,00 & -1,00*M & 0,00\\ 
 \hline 
0,00 & 5,00 & 0,00 & 6,00 & -1,00 & 1,00 & 0,00 & 0,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & 1,00 & 6,00 & 4,00 & -1,00 & 0,00 & 1,00 & 0,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & 4,00 & 4,00 & 8,00 & -1,00 & 0,00 & 0,00 & 1,00 & 0,00 & 0,00\\ 
 \hline 
...
\textbf{Draw:} the rows 1 and 2 have a fraction of the same value,\textbf{row 1} (fraction 0,00000) with the 5,00000 pivot was \textbf{choosen} and \textbf{row 2} (fraction 0,00000) with the 1,00000 pivot was \textbf{stored} along with the table in case it is needed.\\
To appreciate this please see the following table:\\
\textbf{Draw:} the rows 1 and 3 have a fraction of the same value,\textbf{row 1} (fraction 0,00000) with the 5,00000 pivot was \textbf{choosen} and \textbf{row 3} (fraction 0,00000) with the 4,00000 pivot was \textbf{stored} along with the table in case it is needed.\\
To appreciate this please see the following table:\\
Pivoting(1)
\begin{center}
\begin{adjustbox}{max width=1\textwidth,keepaspectratio}
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & \cellcolor{PurpleNoMamado}$y_{1}$ & $y_{2}$ & $y_{3}$ & $y_{4}$ & $s_{1}$ & $s_{2}$ & $s_{3}$ & $a_{1}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & \cellcolor{PurpleNoMamado}1,00*M & 1,00*M & 1,00*M & -1,00 & 0,00 & 0,00 & 0,00 & 0,00 & 1,00*M & $-$\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}5,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}6,00 & \cellcolor{PurpleNoMamado}-1,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00\\ 
 \hline 
0,00 & \cellcolor{PurpleNoMamado}1,00 & 6,00 & 4,00 & -1,00 & 0,00 & 1,00 & 0,00 & 0,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & \cellcolor{PurpleNoMamado}4,00 & 4,00 & 8,00 & -1,00 & 0,00 & 0,00 & 1,00 & 0,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & \cellcolor{PurpleNoMamado}1,00 & 1,00 & 1,00 & 0,00 & 0,00 & 0,00 & 0,00 & 1,00 & 1,00 & 1,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $y_{1}$ & \cellcolor{PurpleNoMamado}$y_{2}$ & $y_{3}$ & $y_{4}$ & $s_{1}$ & $s_{2}$ & $s_{3}$ & $a_{1}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & 0,00 & \cellcolor{PurpleNoMamado}1,00*M & -0,20*M & 0,20*M + -1,00 & -0,20*M & 0,00 & 0,00 & 0,00 & 1,00*M & $-$\\ 
 \hline 
0,00 & 1,00 & \cellcolor{PurpleNoMamado}0,00 & 1,20 & -0,20 & 0,20 & 0,00 & 0,00 & 0,00 & 0,00 & $-$\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}6,00 & \cellcolor{PurpleNoMamado}2,80 & \cellcolor{PurpleNoMamado}-0,80 & \cellcolor{PurpleNoMamado}-0,20 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00\\ 
 \hline 
0,00 & 0,00 & \cellcolor{PurpleNoMamado}4,00 & 3,20 & -0,20 & -0,80 & 0,00 & 1,00 & 0,00 & 0,00 & 0,00\\ 
 \hline 
0,00 & 0,00 & \cellcolor{PurpleNoMamado}1,00 & -0,20 & 0,20 & -0,20 & 0,00 & 0,00 & 1,00 & 1,00 & 1,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $y_{1}$ & $y_{2}$ & $y_{3}$ & \cellcolor{PurpleNoMamado}$y_{4}$ & $s_{1}$ & $s_{2}$ & $s_{3}$ & $a_{1}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & 0,00 & 0,00 & -0,67*M & \cellcolor{PurpleNoMamado}0,33*M + -1,00 & -0,17*M & -0,17*M & 0,00 & 0,00 & 1,00*M & $-$\\ 
 \hline 
0,00 & 1,00 & 0,00 & 1,20 & \cellcolor{PurpleNoMamado}-0,20 & 0,20 & 0,00 & 0,00 & 0,00 & 0,00 & $-$\\ 
 \hline 
0,00 & 0,00 & 1,00 & 0,47 & \cellcolor{PurpleNoMamado}-0,13 & -0,03 & 0,17 & 0,00 & 0,00 & 0,00 & $-$\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}1,33 & \cellcolor{PurpleNoMamado}0,33 & \cellcolor{PurpleNoMamado}-0,67 & \cellcolor{PurpleNoMamado}-0,67 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00\\ 
 \hline 
0,00 & 0,00 & 0,00 & -0,67 & \cellcolor{PurpleNoMamado}0,33 & -0,17 & -0,17 & 0,00 & 1,00 & 1,00 & 3,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $y_{1}$ & $y_{2}$ & $y_{3}$ & $y_{4}$ & $s_{1}$ & \cellcolor{PurpleNoMamado}$s_{2}$ & $s_{3}$ & $a_{1}$ & $B$ & $Fraction$\\ 
 \hline 
1,00 & 0,00 & 0,00 & -2,00*M + 4,00 & 0,00 & 0,50*M + -2,00 & \cellcolor{PurpleNoMamado}0,50*M + -2,00 & -1,00*M + 3,00 & 0,00 & 1,00*M & $-$\\ 
 \hline 
0,00 & 1,00 & 0,00 & 2,00 & 0,00 & -0,20 & \cellcolor{PurpleNoMamado}-0,40 & 0,60 & 0,00 & 0,00 & $-$\\ 
 \hline 
0,00 & 0,00 & 1,00 & 1,00 & 0,00 & -0,30 & \cellcolor{PurpleNoMamado}-0,10 & 0,40 & 0,00 & 0,00 & $-$\\ 
 \hline 
0,00 & 0,00 & 0,00 & 4,00 & 1,00 & -2,00 & \cellcolor{PurpleNoMamado}-2,00 & 3,00 & 0,00 & 0,00 & $-$\\ 
 \hline 
\cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}-2,00 & \cellcolor{PurpleNoMamado}0,00 & \cellcolor{PurpleNoMamado}0,50 & \cellcolor{PurpleNoMamado}0,50 & \cellcolor{PurpleNoMamado}-1,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}1,00 & \cellcolor{PurpleNoMamado}2,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|} 
 \hline 
$Z$ & $y_{1}$ & $y_{2}$ & $y_{3}$ & $y_{4}$ & $s_{1}$ & $s_{2}$ & $s_{3}$ & $B$\\ 
 \hline 
1,00 & 0,00 & 0,00 & -4,00 & 0,00 & -0,00 & 0,00 & -1,00 & 4,00\\ 
 \hline 
0,00 & 1,00 & 0,00 & 0,40 & 0,00 & 0,20 & 0,00 & -0,20 & 0,80\\ 
 \hline 
0,00 & 0,00 & 1,00 & 0,60 & 0,00 & -0,20 & 0,00 & 0,20 & 0,20\\ 
 \hline 
0,00 & 0,00 & 0,00 & -4,00 & 1,00 & -0,00 & 0,00 & -1,00 & 4,00\\ 
 \hline 
0,00 & 0,00 & 0,00 & -4,00 & 0,00 & 1,00 & 1,00 & -2,00 & 2,00\\ 
 \hline 
\end{tabular} 
\end{adjustbox}
\end{center}
...
1,00 & 0,00 & 0,00 & -4,00 & 0,00 & 0,00 & 0,00 & -1,00 & 4,00\\ 
 \hline 
0,00 & 1,00 & 0,00 & 1,20 & 0,00 & 0,00 & -0,20 & 0,20 & 0,40\\ 
 \hline 
0,00 & 0,00 & 1,00 & -0,20 & 0,00 & 0,00 & 0,20 & -0,20 & 0,60\\ 
 \hline 
0,00 & 0,00 & 0,00 & -4,00 & 1,00 & 0,00 & 0,00 & -1,00 & 4,00\\ 
 \hline 
0,00 & 0,00 & 0,00 & -4,00 & 0,00 & 1,00 & 1,00 & -2,00 & 2,00\\ 
...
z=4,00\\
\textbf{Solution 1:}\\
$y_{1}= 0,80; y_{2}= 0,20; y_{3}= 0,00; y_{4}= 4,00; s_{1}= 0,00; s_{2}= 2,00; s_{3}= 0,00; a_{1}= 0,00$\\
\textbf{Solution 2:}\\
$y_{1}= 0,40; y_{2}= 0,60; y_{3}= 0,00; y_{4}= 4,00; s_{1}= 2,00; s_{2}= 0,00; s_{3}= 0,00; a_{1}= 0,00$\\
\textbf{Solution 3:}\\
$y_{1}= 0,50; y_{2}= 0,50; y_{3}= 0,00; y_{4}= 4,00; s_{1}= 1,50; s_{2}= 0,50; s_{3}= 0,00; a_{1}= 0,00$\\
\textbf{Solution 4:}\\
$y_{1}= 0,60; y_{2}= 0,40; y_{3}= 0,00; y_{4}= 4,00; s_{1}= 1,00; s_{2}= 1,00; s_{3}= 0,00; a_{1}= 0,00$\\
\textbf{Solution 5:}\\
$y_{1}= 0,70; y_{2}= 0,30; y_{3}= 0,00; y_{4}= 4,00; s_{1}= 0,50; s_{2}= 1,50; s_{3}= 0,00; a_{1}= 0,00$\\
